...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // =========================
       const services = [
        ...
        { id: 8, title: "Maintenance", category: "maintenance", description: "Keep your websites and systems running smoothly with regular updates and support.", image: "assets/images/img/maintain.png" },
    ...
    function renderServices(filteredServices) {
        ...
        filteredServices.forEach((service, index) => {
            ...
            card.tabIndex = 0;
            card.innerHTML = `
                <img src="${service.image}" alt="${service.title}" width="${service.width}" height="${service.height}" loading="lazy">
                <h3>${service.title}</h3>
